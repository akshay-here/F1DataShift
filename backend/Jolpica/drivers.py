...
async def get_driver_races(driver: str): 
    ...
    async with httpx.AsyncClient() as client:
        ...
        if not driver_races:
                raise HTTPException(status_code=404, detail=f"No race data found for {driver}")
        return driver_races
...
async def get_driver_races_year(driver: str, year: int): 
    ...
    async with httpx.AsyncClient() as client:
        ...
        driver_races_year = data["MRData"]["RaceTable"]["Races"]
...
async def get_driver_qualifying(driver: str): 
    ...
    async with httpx.AsyncClient() as client:
        ...
        if not driver_qualifying:
                raise HTTPException(status_code=404, detail=f"No qualifying data found for {driver}")
...
async def get_driver_qualifying_year(driver: str, year: int): 
    ...
    async with httpx.AsyncClient() as client:
        ...
        driver_qualifying_year = data["MRData"]["RaceTable"]["Races"]
...
# used only for calculating stats
async def get_driver_sprints(driver: str): 
    ...
    async with httpx.AsyncClient() as client:
        ...
        driver_sprints = data["MRData"]["RaceTable"]["Races"]
        if not driver_sprints:
                raise HTTPException(status_code=404, detail=f"No sprint data found for {driver}")
...
async def get_driver_sprints_year(driver: str, year: int): 
    ...
    async with httpx.AsyncClient() as client:
        ...
        driver_sprints_year = data["MRData"]["RaceTable"]["Races"]
...
async def get_driver_standings_year(driver: str, year: int): 
    ...
    async with httpx.AsyncClient() as client:
        ...
        driver_standings_year = data["MRData"]["StandingsTable"]["StandingsLists"]
...
async def get_driver_profile(driver: str): 
    ...
    async with httpx.AsyncClient() as client:
        ...
        driver_profile = data["MRData"]["DriverTable"]["Drivers"]
