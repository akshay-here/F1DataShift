...
const Hyperspeed = ({ effectOptions = {}, containerWidth = '100%', containerHeight = '30rem' }) => {
  ...
  useEffect(() => {
    ...
    console.log('Hyperspeed mounting');
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // Append canvas only if none exists
    ...
    // Set distortion
    const options = { ...effectOptions, distortion: distortions[effectOptions.distortion || 'turbulentDistortion'] };

    // Initialize App
    appRef.current = new App(container, options);
    appRef.current.setSize(container.offsetWidth, parseFloat(containerHeight) || container.offsetHeight);
    ...
    // Cleanup
    return () => {
      console.log('Cleaning up Hyperspeed');
